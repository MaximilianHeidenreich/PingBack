...
<div bind:this={triggerEl} class="w-full mt-4 mb-6 flex flex-col justify-center items-center gap-2">
    {#if done}
        <span class="text-sm text-neutral-500">No more data</span>
    {:else}
        {#if loading}
        <span class="animate-spin"><IconLoader size={ICON_TOKENS.SIZE.SM} stroke={ICON_TOKENS.STROKE.BASE}/></span>
