<script lang="ts">
    ...
    import { clientDeleteProjectChannelRaw, clientDeleteProjectRaw } from "$lib/helpers/api/projectsClient";
...
<Modal bind:dialog>
    ...
    <svelte:fragment slot="subtitle">
        Are you sure you want to delete <strong class="text-pink-500 font-mono">#{channelID}</strong>?
        This action cannot be reversed -> in the future it will be possible to migrate events to another channel though.
    </svelte:fragment>
