import { fetchAllEvents, fetchEvents } from "$lib/api/apiEvents";
...
export async function store_fetchEvents(projectId: string, filters?: IFetchEventArgs, reset: boolean = false) {
